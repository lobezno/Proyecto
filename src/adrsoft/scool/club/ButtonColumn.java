...
public class ButtonColumn extends AbstractCellEditor implements TableCellRenderer, TableCellEditor, ActionListener, MouseListener{
		...
		JTable table, Object value, boolean isSelected, int row, int column)
	{
		...
		{
			editButton.setText( "" );
			editButton.setIcon( new ImageIcon(AlumnosMain.class.getResource("/adrsoft/scool/resources/images/low/mail.png")) );
		}
...
//		renderButton.setText( (value == null) ? "" : value.toString() );
		if (value == null)
		{
			...
			renderButton.setIcon( new ImageIcon(AlumnosMain.class.getResource("/adrsoft/scool/resources/images/low/mail.png")) );
		}
		else if (value instanceof Icon)
		{
			renderButton.setText( "" );
